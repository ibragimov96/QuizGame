...
public class QuizActivity extends AppCompatActivity {
    ...
    private static final String KEY_SCORE = "keysScore";
    private static final String KEY_QUESTION_COUNT = "keysQuestionCount";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewDifficulty = findViewById(R.id.txt_difficulty);
        ...
        rb4 = findViewById(R.id.radio_btn_4);
